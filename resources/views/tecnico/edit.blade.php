...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form class="needs-validation" action="/patfa-monitoreos/public/tecnicos/{{ $tecnico->id }}" method="POST" novalidate>
                @csrf @method('PATCH')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="/tecnicos" class="btn btn-danger btn-block"><i class="far fa-arrow-alt-circle-left"> </i>
                            Regresar</a>
                    </div>
                    <div class="col-md-6">
