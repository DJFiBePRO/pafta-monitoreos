...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form class="needs-validation" action="{{ route('fincas.update', $finca->id) }}" method="POST" novalidate>
                @csrf @method('PATCH')
                <div class="form-goup">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="{{ route('fincas.index') }}" class="btn btn-danger btn-block"><i class="far fa-arrow-alt-circle-left"> </i>
                            Regresar</a>
                    </div>
                    <div class="col-md-6">
